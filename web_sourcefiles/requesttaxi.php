...
if (isset($_POST['driver_id']) && isset($_POST['driver_name'])  && isset($_POST['driver_email']) && isset($_POST['sender_id']) && isset($_POST['name']) && isset($_POST['phone'])
	...
	$db = new DB_CONNECT();
	$sql="INSERT INTO texirequest (driver_id, driver_name, driver_email,sender_id,name,phone,location,droplocation,latitude,longitude,timedate)".
	"VALUES ('$driver_id', '$driver_name','$driver_email','$sender_id','$name','$phone','$location','$droplocation','$latitude','$longitude','$timedate')";
